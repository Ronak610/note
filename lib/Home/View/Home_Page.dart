      ...
      child: Scaffold(
        ...
        body: Stack(
          children:[
            ...
            if(showBanner)
              Card(child: Container(color: Colors.pink,width: double.infinity,child: Padding(padding: EdgeInsets.all(16.0),child: Text(bannerText,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),)),),)
       ]
        ),
      ),
    );
